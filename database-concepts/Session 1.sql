/*create database ArthPrajapatiDB;
...
select top 2 * from individuals;

Select top 20 percent * from individuals;
...
update individuals set Username='funnyman' where Individualid=6


select count(Lastname) from individuals

select count(distinct(Firstname)) from individuals
*/